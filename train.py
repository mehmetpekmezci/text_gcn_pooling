...
#    print("len(support[0]):", len(support[0]))
#    print("support[0][0]:", support[0][0].shape)
#    print("support[0][1]:", support[0][1].shape)
#    print("len(support[0][2]):", len(support[0][2]))
#    print("support[0][2][0]:", support[0][2][0])
#    print("support[0][2][1]:", support[0][2][1])
#    print("len(features):", len(features))
#    print("features:", features)
#    print("model.opt_op:", model.opt_op)
#    print("model.layers[0].embedding:", model.layers[0].embedding)
    # Training step
